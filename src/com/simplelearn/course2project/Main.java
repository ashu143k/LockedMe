...
public class Main {
	...
	private static void searchAFile() {
		...
		File searchFileDirectory = new File("C:\\Users\\ashis\\eclipse-workspace\\AssessmentProject\\Files\\" + searchFileName);
		if (searchFileDirectory.exists()) {
	...
	private static void deleteFile() {
		...
		File deleteFileDirectory = new File("C:\\Users\\ashis\\eclipse-workspace\\AssessmentProject\\Files\\" + deleteFileName);
